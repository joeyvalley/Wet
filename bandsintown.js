...
function setEvents(events) {
  ...
  if (events.length !== 0) {
    events.forEach(event => {
      ...
      p.innerHTML = '<span class="left">' + event.venue.name + '</span><span class="right">' + formattedDate + '</span><br /><span class="left">' + event.venue.location + '</span><span class="right"><a href="' + event.url + '" target ="_blank">Buy Tickets</a></span><br />';
      div.append(p)
    });
  }
  else {
